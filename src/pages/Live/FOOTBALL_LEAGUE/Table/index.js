        ...
        <div className={style.block}>
            <div className={style.left}>
                <div className={style.results}>
                    {
                        data.event.league.matches.map((el_m, idx_m) =>
                            <div
                                key={idx_m}
                                className={style.row}
                            >
            ...
            <div className={style.right}>
                <Slider {...init}>
                    {
                        data.event.league.matches[0].odds[0].groups.slice(0, data.event.league.matches[0].odds[0].groups.length - 1).map((el_o, idx_o)  =>
                            <div
                                key={idx_o}
                            ...
                            >
                                <div className={style.head}>
                                    {
                                        data.event.league.matches[0].odds[0].groups[idx_o].markets.map((el_ma, idx_ma) =>
                                            <div
                                                key={idx_ma}
                    ...
                    {
                        data.event.league.matches[0].odds[0].groups[7].markets.map((el_ma, idx_ma) =>
                            <div
                                key={idx_ma}
                                className={style.slide}
                            >
