...
export const data = {
  ...
  sectors: [
    {
      stake: `${rouletteType.SECTOR}: A`,
      print: `${rouletteType.SECTOR}: A`,
      odd: 6,
      name: 'a',
    },
    {
      stake: `${rouletteType.SECTOR}: B`,
      print: `${rouletteType.SECTOR}: B`,
      odd: 6,
      name: 'b',
    },
    {
      stake: `${rouletteType.SECTOR}: C`,
      print: `${rouletteType.SECTOR}: C`,
      odd: 6,
      name: 'c',
    },
    {
      stake: `${rouletteType.SECTOR}: D`,
      print: `${rouletteType.SECTOR}: D`,
      odd: 6,
      name: 'd',
    },
    {
      stake: `${rouletteType.SECTOR}: E`,
      print: `${rouletteType.SECTOR}: E`,
      odd: 6,
      name: 'e',
    },
    {
      stake: `${rouletteType.SECTOR}: F`,
      print: `${rouletteType.SECTOR}: F`,
      odd: 6,
      name: 'f',
    },
  ],
  low_high_color: [
    {
      stake: `${rouletteType.LOW_HIGH_COLOR}: HIGH RED`,
      print: `${rouletteType.LOW_HIGH_COLOR}: HIGH RED`,
      odd: 4,
      name: 'high',
      color: 'red'
    },
    {
      stake: `${rouletteType.LOW_HIGH_COLOR}: HIGH BLACK`,
      print: `${rouletteType.LOW_HIGH_COLOR}: HIGH BLACK`,
      odd: 4,
      name: 'high',
      color: 'black'
    },
    {
      stake: `${rouletteType.LOW_HIGH_COLOR}: LOW RED`,
      print: `${rouletteType.LOW_HIGH_COLOR}: LOW RED`,
      odd: 4,
      name: 'low',
      color: 'red'
    },
    {
      stake: `${rouletteType.LOW_HIGH_COLOR}: LOW BLACK`,
      print: `${rouletteType.LOW_HIGH_COLOR}: LOW BLACK`,
      odd: 4,
      name: 'low',
      color: 'black'
    }
  ...
  finals: [
    {
      stake: `${rouletteType.FINALS}: 0`,
      print: `${rouletteType.FINALS}: 0`,
      odd: 9,
      name: 0,
    },
    {
      stake: `${rouletteType.FINALS}: 1`,
      print: `${rouletteType.FINALS}: 1`,
      odd: 9,
      name: 1,
    },
    {
      stake: `${rouletteType.FINALS}: 2`,
      print: `${rouletteType.FINALS}: 2`,
      odd: 9,
      name: 2,
    },
    {
      stake: `${rouletteType.FINALS}: 3`,
      print: `${rouletteType.FINALS}: 3`,
      odd: 9,
      name: 3,
    },
    {
      stake: `${rouletteType.FINALS}: 4`,
      print: `${rouletteType.FINALS}: 4`,
      odd: 9,
      name: 4,
    },
    {
      stake: `${rouletteType.FINALS}: 5`,
      print: `${rouletteType.FINALS}: 5`,
      odd: 9,
      name: 5,
    },
    {
      stake: `${rouletteType.FINALS}: 6`,
      print: `${rouletteType.FINALS}: 6`,
      odd: 9,
      name: 6,
    },
    {
      stake: `${rouletteType.FINALS}: 7`,
      print: `${rouletteType.FINALS}: 7`,
      odd: 9,
      name: 7,
    },
    {
      stake: `${rouletteType.FINALS}: 8`,
      print: `${rouletteType.FINALS}: 8`,
      odd: 9,
      name: 8,
    },
    {
      stake: `${rouletteType.FINALS}: 9`,
      print: `${rouletteType.FINALS}: 9`,
      odd: 9,
      name: 9,
    },
  ],
  twins: [
    {
      stake: `${rouletteType.TWINS}: 11, 22, 33`,
      print: `${rouletteType.TWINS}: 11, 22, 33`,
      odd: 12,
      name: '11 | 22 | 33',
    }
  ],
  mirror: [
    {
      stake: `${rouletteType.MIRROR}: 12, 21`,
      print: `${rouletteType.MIRROR}: 12, 21`,
      odd: 18,
      name: '12 | 21',
    },
    {
      stake: `${rouletteType.MIRROR}: 13, 31`,
      print: `${rouletteType.MIRROR}: 13, 31`,
      odd: 18,
      name: '13 | 31',
    },
    {
      stake: `${rouletteType.MIRROR}: 23, 32`,
      print: `${rouletteType.MIRROR}: 23, 32`,
      odd: 18,
      name: '23 | 32',
    }
  ]
